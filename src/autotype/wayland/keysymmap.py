...
if len(sys.argv) >= 2:
    ...
    keysymdef = "/usr/include/xkbcommon/xkbcommon-keysyms.h"
...
print("""/*
 *  Automatically generated by keysymmap.py from parsing xkbcommon-keysyms.h.
 */

#include <cstdint>
""")

print("constexpr int UnicodeToKeysymLen = {0};".format(len(keysymMap)))

print()

print("constexpr uint32_t UnicodeToKeysymKeys[] = {")
keys = keysymMap.keys()
keyLen = len(keys)
...
print("constexpr uint32_t UnicodeToKeysymValues[] = {")
